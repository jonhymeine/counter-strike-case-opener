...
function DropdownButton({buttonRef, active, setActive, selectedItem, direction}: DropdownButtonProps) {
    ...
    return (
        <button
            ...
            className={`w-60 h-16 flex items-center hover:bg-zinc-900  text-white font-bold text-xl py-2 px-4 rounded-md select-none ${
                active ? directionStyleOnActive : 'bg-zinc-800 bg-opacity-80'
            }`}>
